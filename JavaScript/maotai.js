...
[Script]
茅台Token = type=http-request,pattern=^https:\/\/app\.moutai519\.com\.cn\/xhr\/front\/mall\/message\/unRead\/query,requires-body=0,max-size=0,script-path=https://raw.githubusercontent.com/yjjsto/QuantumultX/main/JavaScript/i-maotai.js

i 茅台 = type=cron,cronexp=17 9 * * *,timeout=60,script-path=https://raw.githubusercontent.com/yjjsto/QuantumultX/main/JavaScript/i-maotai.js,script-update-interval=0
...
[Script]
http-request ^https:\/\/app\.moutai519\.com\.cn\/xhr\/front\/mall\/message\/unRead\/query tag=茅台Token, script-path=https://raw.githubusercontent.com/yjjsto/QuantumultX/main/JavaScript/i-maotai.js,requires-body=0

cron "17 9 * * *" script-path=https://raw.githubusercontent.com/yjjsto/QuantumultX/main/JavaScript/i-maotai.js,tag = i 茅台,enable=true
...
script-providers:
  i 茅台:
    url: https://raw.githubusercontent.com/yjjsto/QuantumultX/main/JavaScript/i-maotai.js
    interval: 86400
...
!(async () => {
  ...
  for (let i = 0; i < CookieArr.length; i++) {
    ...
    console.log(`\n======== 账号${i + 1} ========\n`);
    let randomInt = Math.floor(Math.random() * 150);  // 随机等待 0-150 秒
