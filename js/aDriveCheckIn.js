...
[task_local]
10 0,7,11 * * * https://gist.githubusercontent.com/Sliverkiss/33800a98dcd029ba09f8b6fc6f0f5162/raw/aliyun.js, tag=阿里云签到, img-url=https://raw.githubusercontent.com/fmz200/wool_scripts/main/icons/apps/AliYunDrive.png, enabled=true
    ...
    if ($request && $request.method != 'OPTIONS') {
        try {
            ...
            if ((Array.isArray(userCookie)) && userCookie.length == 0) {
                ...
                $.msg($.name, `账号[${nick_name}]:`, "🎉写入refresh_token成功!", { 'media-url': avatar });
            } else {
